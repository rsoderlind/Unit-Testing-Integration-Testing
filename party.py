...
def is_mel(name, email):
    ...
    >>> is_mel('Ramona Soderlind', 'ramna@awesome.com')
    False

    >>> is_mel('Gari', 'gari@awesome.com')
    False

    >>> is_mel('Mel Mister', 'mel@ubermelon.com')
    True

    >>> is_mel('Mel Melitpolski', 'me@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'drink'},{'type': 'drink'}, {'type': 'drink'},{'type': 'drink'}])
    ('dessert', 'dessert')
